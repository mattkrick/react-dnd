...
var DragDropMonitorImpl = /** @class */ (function() {
	...
	DragDropMonitorImpl.prototype.subscribeToStateChange = function(
		listener,
		options,
	) {
		var _this = this
		...
		invariant_1.default(
			typeof handlerIds === 'undefined' || isArray_1.default(handlerIds),
