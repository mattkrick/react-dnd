import { Action, DragDropManager, BeginDragPayload, BeginDragOptions, SentinelAction, HoverPayload, HoverOptions, InitCoordsOptions, InitCoordsPayload } from '../interfaces';
...
export default function createDragDropActions<Context>(manager: DragDropManager<Context>): {
    initCoords(sourceIds: string[] | undefined, { clientOffset, getSourceClientOffset }: InitCoordsOptions): Action<InitCoordsPayload> | undefined;
