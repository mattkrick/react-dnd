...
function createDragDropActions(manager) {
	return {
		initCoords: function(sourceIds, _a) {
			if (sourceIds === void 0) {
				sourceIds = []
			}
		...
		beginDrag: function(sourceIds, _a) {
			...
			for (var _i = 0, sourceIds_2 = sourceIds; _i < sourceIds_2.length; _i++) {
				var s = sourceIds_2[_i]
				invariant_1.default(
					registry.getSource(s),
					'Expected sourceIds to be registered.',
				)
		...
		hover: function(targetIdsArg, _a) {
			...
			invariant_1.default(
				isArray_1.default(targetIdsArg),
		...
		drop: function(options) {
			...
			targetIds.forEach(function(targetId, index) {
				...
				invariant_1.default(
					typeof dropResult === 'undefined' || isObject_1.default(dropResult),
