...
var HandlerRegistryImpl = /** @class */ (function() {
	...
	HandlerRegistryImpl.prototype.containsHandler = function(handler) {
		var _this = this
		return (
			Object.keys(this.dragSources).some(function(key) {
				return _this.dragSources[key] === handler
			}) ||
			Object.keys(this.dropTargets).some(function(key) {
				return _this.dropTargets[key] === handler
			})
		)
	}
