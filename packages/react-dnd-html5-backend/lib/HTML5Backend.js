...
var HTML5Backend = /** @class */ (function() {
	...
	HTML5Backend.prototype.connectDragPreview = function(
		sourceId,
		node,
		options,
	) {
	...
	HTML5Backend.prototype.checkIfCurrentDragSourceRectChanged = function() {
		...
		this.currentDragSourceNodeOffsetChanged = !shallowEqual(
			OffsetUtils_1.getNodeClientOffset(node),
	...
	HTML5Backend.prototype.handleTopDragStart = function(e) {
		...
		if (this.monitor.isDragging()) {
			if (typeof dataTransfer.setDragImage === 'function') {
				...
				var dragPreviewOffset = OffsetUtils_1.getDragPreviewOffset(
					sourceNode,
					dragPreview,
					clientOffset,
					anchorPoint,
			...
			var captureDraggingState = this.getCurrentSourcePreviewNodeOptions()
